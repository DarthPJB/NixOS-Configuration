...
set termguicolors
set ttimeoutlen=0                   " Eliminate the pesky escape timeout
set shada="NONE"
...
" <leader>n to remove highlighting
nnoremap <leader>n :nohl<CR>

" <leader><Tab> to convert tabs to 4 spaces
...
" <S-CR> to add a line above and go to it.
inoremap <S-CR> <Esc>O
...
" Run Neomake when writing the file
