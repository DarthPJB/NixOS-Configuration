...
then
	xwinwrap -ov -b -nf -o 1.0 -g 1600x900 -debug -- mplayer -wid WID -loop 0  ~/ascetics_bin/video/gobi_stars.mp4 &
	xwinwrap -ov -b -nf -o 1.0 -g 1920x1080+1600+0 -debug -- mplayer -wid WID -loop 0  ~/ascetics_bin/video/gobi_stars.mp4 && fg
else
